...
public class PreguntasRespuestas2 {
	...
	public static void preguntar(String pregunta) // Dandole tipo String, y cambiandole el parametro a preguntar que
	// tenemos como constante para tenerlo en todas las
	{ // lineas.
